...
public static void limpia_log_evidencia(String escenario, String caso){
	try {
		Variables.Cnn.prepareCall("DELETE FROM TBL_LOG_EVIDENCIA WHERE L_ESCENARIO='" + escenario + "' AND L_VERSION ='" + Variables.S_Version + "' AND L_CORRIDA='" + Variables.S_Corrida + "' AND L_ID_CASO='" + caso + "'").execute();
	        ...
	        System.out.println("Fallo la eliminación en la tabla TBL_LOG_EVIDENCIA " + e.getMessage());
	}
}
	...
	try{
		...
		switch (tipo_accion.toUpperCase()) {
			case "COMBOBOX_GMG":
				...
				Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + tipo_accion + " el valor '" + valor  + "' en el objeto " + Objeto + " con tipo de atributo |" + mapeo_tipo + "| y su valor |" + mapeo_objeto + "|<br>";
				break;
			case "CHECK_GMG":
				break;
...
public static void func_funciones_vector(String Objeto,String mapeo_objeto,String tipo_accion, String mapeo_tipo, String valor, String adicional){
	try{
		...
		case "ESPERA_CARGAR":
			...
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Esperando ... [" + Integer.parseInt(adicional) + " seg.]" + "|<br>";
			break;
		case "ESPERA_OBJETO":
			func_espera_elemento(mapeo_tipo, mapeo_objeto, adicional, Variables.driver);
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Esperando el objeto [" + Objeto + "] con tipo de mapeo [" + mapeo_tipo + "] e identificador [" + mapeo_objeto + "]|<br>";
			break;
		case "ESPERA_TEXTO":
			func_espera_texto(mapeo_objeto, adicional, Variables.driver);
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Esperando el texto [" + Objeto + "] con tipo de mapeo [" + mapeo_tipo + "] e identificador [" + mapeo_objeto + "]|<br>";
			break;
		case "VISUALIZA_TEXTO":
			func_visualizar_texto(mapeo_objeto, adicional, Variables.driver);
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se visualiza el texto [" + Objeto + "] con tipo de mapeo [" + mapeo_tipo + "] e identificador [" + mapeo_objeto + "]|<br>";
			break;
		case "ESPERAR_HABILITADO":
			func_esperar_habilitado(mapeo_objeto,adicional,Variables.driver);
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se espera el objeto [" + Objeto + "] con tipo de mapeo [" + mapeo_tipo + "] e identificador [" + mapeo_objeto + "]|<br>";
			break;
		case "TECLA":
		...
		case "GUARDAR_CONTENIDO":
			...
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se guarda el contenido del Objeto [" + Objeto + "] en el destino [" + adicional + "]|<br>";
			break;
		case "CERRAR_WINDOWS":
			kill_procesos(Variables.web);
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se cierra el aplicativo del Browser " + Variables.web + "|<br>";
			break;
		case "MOUSE_CLICK":
			...
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se da click en las coordenadas: [ " + Variables.P_Parametro_Adicional.split(",")[0] + ", " + Variables.P_Parametro_Adicional.split(",")[1] + "]" + "|<br>";
			break;
		case "MOUSE_COORDENADA":
			...
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se da mueve el puntero del mouse en las coordenadas: [ " + Variables.P_Parametro_Adicional.split(",")[0] + ", " + Variables.P_Parametro_Adicional.split(",")[1] + "]" + "|<br>";
			break;
		case "PRESS_KEY":
			type(valor);
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se presiona las teclas [ " + valor + "]|<br>";
			break;
		...
		case "PRESS_ARRIBA":
			TeclaArriba();
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se presiona la tecla Arriba |<br>";
			break;
		case "PRESS_ABAJO":
			TeclaAbajo();
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se presiona la tecla Abajo |<br>";
			break;
		case "PRESS_DERECHA":
			TeclaDerecha();
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se presiona la tecla Derecha |<br>";
			break;
		case "PRESS_IZQUIERDA":
			TeclaIzquierda();
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + "Se presiona la tecla Izquierda |<br>";
			break;
		}
	}
	catch (Exception e){
...
public static void func_revision (String Objeto, String mapeo_objeto, String tipo_accion, String mapeo_tipo,  String valor, String adicional) {
	...
	switch (tipo_accion.toUpperCase()) {
		case "HABILITADO":
			...
			Variables.cadena_html = Variables.cadena_html + "REVISIÓN: " + tipo_accion + " en el objeto " + Objeto + " con tipo de atributo |" + mapeo_tipo + "| y su valor |" + mapeo_objeto + "|<br>";
			Variables.valida_caso = true;
			break;
		case "CONTIENE_TEXTO":
			highlightElement(Variables.driver.findElement(obtenerObjeto(mapeo_objeto,mapeo_tipo)));//SE RESALTA EL OBJETO		
			Variables.driver.findElement(obtenerObjeto(mapeo_objeto,mapeo_tipo)).getText().trim().contentEquals(valor);
			Variables.cadena_html = Variables.cadena_html + "REVISIÓN: " + tipo_accion + " el valor '" + valor  + "' en el objeto " + Objeto + " con tipo de atributo |" + mapeo_tipo + "| y su valor |" + mapeo_objeto + "|<br>";
			Variables.valida_caso = true;
			break;
		case "TEXTO":
			highlightElement(Variables.driver.findElement(obtenerObjeto(mapeo_objeto,mapeo_tipo)));//SE RESALTA EL OBJETO		
		...
		System.out.println(e.getMessage());		
		Variables.cadena_html = Variables.cadena_html + "<font color='#FF0000'>ERROR EN EL PASO: " + "REVISIÓN: " + tipo_accion + " en el objeto " + Objeto + " con tipo de atributo |" + mapeo_tipo + "| y su valor |" + mapeo_objeto + "| MENSAJE ERROR: " + e.getMessage() + "</font><br>";
		Variables.valida_caso = false;	
	}
}
public static void func_accion (String Objeto, String mapeo_objeto, String tipo_accion, String mapeo_tipo,  String valor, String adicional) {
	...
	case "CLICK":
			highlightElement(Variables.driver.findElement(obtenerObjeto(mapeo_objeto,mapeo_tipo)));//SE RESALTA EL OBJETO		
			Variables.driver.findElement(obtenerObjeto(mapeo_objeto,mapeo_tipo)).click();
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + tipo_accion + " en el objeto " + Objeto + " con tipo de atributo |" + mapeo_tipo + "| y su valor |" + mapeo_objeto + "|<br>";
			Variables.valida_caso=true;
			break;
	case "ESCRIBIR":
			highlightElement(Variables.driver.findElement(obtenerObjeto(mapeo_objeto,mapeo_tipo)));//SE RESALTA EL OBJETO
	...
	case "SELECCIONAR_OPCION":
			...
			//dato = true;
			Variables.cadena_html = Variables.cadena_html + "ACCIÓN: " + tipo_accion + " en la posición [" + valor  + "] en el objeto " + Objeto + " con tipo de atributo |" + mapeo_tipo + "| y su valor |" + mapeo_objeto + "|<br>";
			Variables.valida_caso=true;
			break;
	...
	default:
		...
		System.out.println(e.getMessage());		
		Variables.cadena_html = Variables.cadena_html + "<font color='#FF0000'>ERROR EN EL PASO: " + "ACCIÓN: " + tipo_accion + " en el objeto " + Objeto + " con tipo de atributo |" + mapeo_tipo + "| y su valor |" + mapeo_objeto + "| MENSAJE ERROR: " + e.getMessage() + "</font><br>";
		Variables.valida_caso = false;	
	}
}
public static void func_esperar_habilitado (String mapeo_objeto, String tiempo, WebDriver driver) throws InterruptedException{
	...
	while (driver.findElement(By.xpath(mapeo_objeto)).isEnabled()==false){
		...
		if (cont>Integer.parseInt(tiempo)){
			System.out.println("Objeto NO visualizado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + tiempo + " .seg");
			Variables.cadena_html = Variables.cadena_html + "Objeto NO visualizado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + tiempo + " .seg" + "|<br>";
			Variables.valida_caso=false;
			break;
		}
	}
	System.out.println("Objeto visualizado [" + mapeo_objeto + "]: " + getHoraActual()+" , por un período de: " + cont + " .seg");
	Variables.cadena_html = Variables.cadena_html + "Objeto visualizado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + cont + " .seg" + "|<br>";
	Variables.valida_caso=true;
	Thread.sleep(500);
}
	...
	try{
		...
		while(true){
			...
			if(intentos >  Integer.parseInt(tiempo)){
				System.out.println("Texto NO encontrado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + tiempo + " .seg");
				Variables.cadena_html = Variables.cadena_html + "Texto NO encontrado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + tiempo + " .seg" + "|<br>";
				Variables.valida_caso = false;
			}
...
try {
	...
	while (driver.findElement(By.xpath(mapeo_objeto)).isDisplayed()){
		...
		System.out.println("Esperando: " + cont);
		if (cont>Integer.parseInt(tiempo)){
			System.out.println("Texto NO visualizado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + tiempo + " .seg");
		    //cadena_html = cadena_html + "Texto NO visualizado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + tiempo + " .seg" + "|<br>";
			//Variables.valida_caso=false;
			break;
		}
	}
	System.out.println("Texto visualizado [" + mapeo_objeto + "]: " + getHoraActual()+" , por un período de: " + cont + " .seg");
	Variables.cadena_html = Variables.cadena_html + "Texto visualizado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + cont + " .seg" + "|<br>";
	Variables.valida_caso=true;
}
catch (Exception e) {
		System.out.println(e.getMessage());
...
public static void func_espera_elemento (String mapeo_tipo,String mapeo_objeto, String tiempo, WebDriver driver){
	try{
    	...
    	while(true){
    		...
    		System.out.println ("Esperando: " + intentos);
    		if(intentos >  Integer.parseInt(tiempo)){
    		System.out.println("Objeto NO encontrado [" + mapeo_objeto + "]: " + getHoraActual()+" , en un máximo de: " + tiempo + " .seg");
			Variables.cadena_html = Variables.cadena_html + "Objeto NO encontrado [" + mapeo_objeto + "]: " + getHoraActual() +" , en un máximo de: " + tiempo + " .seg" + "|<br>";
			Variables.valida_caso = false;
			break;
    		}
    		try{Thread.sleep(1000);}catch(Throwable e){}	//espera un segundo
...
public static void generar_evidencia_caso (String file, String escenario, String caso) throws IOException {
	try{
		   ...
		   pw.println("<TABLE class = 'altrowstable'>");
	        ...
	        pw.println("<TR><TD><b>Responsable Automatización :</b> </TD><TD>" + Variables.S_Arquitecto_QA + "</TD></TR>");
	        pw.println("<TR><TD><b>Descripción :</b> </TD><TD>" + Variables.cadena_html_descripcion + "</TD></TR>");
...
public static void generar_reporte_evidencia(String file,String escenario) throws IOException {
	try{
		   ...
		   pw.println("<TABLE class = 'altrowstable'>");
           pw.println("<TR ALIGN=CENTER><TD COLSPAN=2><IMG SRC='" + file + "logo_ch.jpg'></TD></TR>");
           pw.println("<TR ALIGN=CENTER><TD COLSPAN=2>EVIDENCIA PRUEBAS FUNCIONALES ITERACIÓN N° " + Variables.S_Corrida +  "</CENTER></TD></TR>");
           pw.println("<TR><TD><b>Proyecto:</b> </TD><TD>" + Variables.str_escenario + "</TD></TR>");
           pw.println("<TR><TD><b>Version: </b> </TD><TD>" + Variables.S_Version + "</TD></TR>");
           pw.println("<TR><TD><b>Hora y fecha del reporte: </b> </TD><TD>" + getFechaActual() + " " + getHoraActual() + "</TD></TR>");
           pw.println("<TR><TD><b>Responsable Automatización :</b> </TD><TD>" + Variables.S_Arquitecto_QA + "</TD></TR>");
		  	...
		  	case "FIREFOX":
		        ...
		        capabilitiesf.setCapability("marionette", true);
		  		...
		  		*/
		  		...
		  		break;
		  default:
			  	  Variables.cadena_html = Variables.cadena_html + "No se indicó el Browser en la tabla Schedule ... ";
			  	  Variables.valida_caso=false;
			  	  break;
		  }   
